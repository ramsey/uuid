...
class Uuid implements Rfc4122UuidInterface
{
     ...
     * @param int<0, 16383> | null $clockSeq A 14-bit number used to help avoid duplicates that could arise when the clock is set
     ...
     *
     * @param Hexadecimal | non-empty-string | positive-int | null $node A 48-bit number representing the hardware
     *     address; this number may be represented as an integer or a hexadecimal string
     ...
     *     is set backwards in time or if the node ID changes (in a version 2 UUID, the lower 8 bits of this number are
     ...
     *
     * @param UuidInterface | non-empty-string $ns The namespace (must be a valid UUID)
