 ...
 * @param int<0, 16383> | null $clockSeq A 14-bit number used to help avoid duplicates that could arise when the clock
 ...
 *     POSIX systems, if the local domain is "person" or "group," or it may be a site-defined identifier if the local
 *     domain is "org"
 * @param Hexadecimal | null $node A 48-bit number representing the hardware address
 * @param int<0, 63> | null $clockSeq A 6-bit number used to help avoid duplicates that could arise when the clock is set
