...
interface TimeConverterInterface
{
     ...
     *
     * @param numeric-string $seconds A string representation of seconds since the Unix epoch for the time to calculate
     * @param numeric-string $microseconds A string representation of the micro-seconds associated with the time to calculate
     *
