...
interface CodecInterface
{
     ...
     *
     * @param non-empty-string $encodedUuid The hexadecimal string representation to convert into a UuidInterface instance
     *
     ...
     *
     * @param non-empty-string $bytes The binary string representation to convert into a UuidInterface instance
     *
